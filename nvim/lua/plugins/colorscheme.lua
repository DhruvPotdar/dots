    ...
    { 'rose-pine/neovim' },
    {
        ...
        config = function()
            require('catppuccin').setup {
                ...
                --             FloatBorder = { bg = colors.none, fg = colors.text },
                ...
                --             NeoTreeVertSplit = { bg = colors.none },
                --             NeoTreeRootName = { fg = colors.subtext1, style = { 'bold' } },
                --             NeoTreeTabActive = { fg = colors.text, bg = colors.none },
                --             NeoTreeTabInactive = { fg = colors.surface2, bg = colors.none },
