			...
			config = function()
				require("kanagawa").setup({
					...
					overrides = function(colors)
						...
						-- Purple color from the image (OniViolet)
						local ui_color = "#4f4f68"
						...
						return {
							...
							CursorLineNr = { bg = "none", fg = ui_color },
							FoldColumn = { bg = "none" },
							VertSplit = { bg = "none" },
							...
							NormalFloat = { bg = "none" },
							FloatBorder = { bg = "none", fg = ui_color },
							...
							NoicePopup = { bg = "none" },
							NoiceCmdlineIcon = { fg = ui_color },
							NoiceCmdlineIconSearch = { fg = palette.surimiOrange },

							-- Snacks Input
							SnacksInputNormal = { bg = "none" },
							SnacksInputTitle = { fg = ui_color, bg = "none", bold = true },
							SnacksInputBorder = { link = "FloatBorder" },
							SnacksInputIcon = { fg = ui_color },

							-- Snacks Backdrop
							SnacksBackdrop = { bg = "#000000", blend = 30 },

							-- fzf-lua borders
							FzfLuaBorder = { link = "FloatBorder" },
							FzfLuaFzfBorder = { link = "FloatBorder" },
							...
							-- blink.cmp menu transparency & matching borders
