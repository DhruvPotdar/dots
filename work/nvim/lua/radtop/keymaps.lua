-- keymappings.lua - Custom keymappings for Neovim with snacks.nvim
-- This file should be required in your init.lua or other configuration
...
-- toggle options - using snacks.nvim
